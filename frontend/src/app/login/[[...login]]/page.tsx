      ...
      <div className="hidden lg:flex lg:col-span-5 flex-col justify-between p-12 border-r border-zinc-900 bg-zinc-950/40 relative z-10">
        ...
        <div className="space-y-6 my-auto max-w-md">
          ...
          <p className="text-zinc-400 leading-relaxed text-sm">
            Access your secure compliance control room. Monitor system activity ledger logs, track policies, trigger automated AI workflows, and oversee organization operations with mathematical guardrails.
          </p>
        </div>
          ...
          <SignIn
            appearance={{
              ...
              elements: {
                ...
                identityPreviewEditButton: "text-zinc-300 hover:text-zinc-100",
              },
            }}
          />
        </div>
